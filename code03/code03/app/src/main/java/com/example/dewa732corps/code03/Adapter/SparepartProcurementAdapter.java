...
//        final SparepartProcurement data = SparepartProcurementBundle.get(i);
        ...
        vh.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("id", data.getIdProcurement());
                intent.putExtra("date", data.getDateProcurement());
                intent.putExtra("supplier", data.getNameSales());
                intent.putExtra("sales", data.getNameSales());
                intent.putExtra("statusprocurement", data.getStatusProcurement());
...
//                Call<ResponseBody> deleteSparepartProcurement = apiClient.deleteSparepartProcurement(data.getId());
