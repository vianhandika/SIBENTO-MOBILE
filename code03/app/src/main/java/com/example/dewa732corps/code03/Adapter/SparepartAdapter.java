...
//        public LinearLayout bottomWraper;
        ...
        public MyViewHolder(View v) {
            super(v);
            Nama = v.findViewById(R.id.namaSparepart);
            Kode = v.findViewById(R.id.kodeSparepart);
            Merk = v.findViewById(R.id.merkSparepart);
            Stock = v.findViewById(R.id.stockSparepart);
...
//            topWraper = v.findViewById(R.id.top_wrapper);
    ...
    public void onBindViewHolder(@NonNull SparepartAdapter.MyViewHolder vh, final int i) {
        ...
        vh.Nama.setText(data.getName());
        vh.Kode.setText(data.getId());
        vh.Merk.setText(data.getBrand());
